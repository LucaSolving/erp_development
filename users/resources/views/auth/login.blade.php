...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="https://mlmw.lucasolving.com/images/logo.svg" width="200"></a>
    </div>
</nav>
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 col-sm-12 logo-top">
			<img src="https://mlmw.lucasolving.com/images/image_login.png" width="100%">
        </div>
        <div class="col-md-6 col-sm-12">
            <h2>Bienvenido Microservicios de Users</h2>
